...
Require-Contains $launchCmd "1440p, 4K, and aspect-correct ultrawide"
...
Require-Contains $readme "aspect-correct"
Require-Contains $readme "ultrawide display choices"
