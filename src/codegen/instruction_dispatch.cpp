...
static const std::unordered_map<int, Builder>& GetDispatchTable() {
  static const std::unordered_map<int, Builder> table = {
      ...
      {PPC_INST_BCLR, build_bclr},
      {PPC_INST_BCLRL, build_bclrl},
      {PPC_INST_BCTR, build_bctr},
      {PPC_INST_BCTRL, build_bctrl},
      {PPC_INST_BLTCTR, build_bltctr},
      {PPC_INST_BLTCTRL, build_bltctrl},
      {PPC_INST_BGTCTR, build_bgtctr},
      {PPC_INST_BGTCTRL, build_bgtctrl},
      {PPC_INST_BEQCTR, build_beqctr},
      {PPC_INST_BEQCTRL, build_beqctrl},
      {PPC_INST_BSOCTR, build_bsoctr},
      {PPC_INST_BSOCTRL, build_bsoctrl},
      {PPC_INST_BUNCTR, build_bsoctr},
      {PPC_INST_BUNCTRL, build_bsoctrl},
      {PPC_INST_BGECTR, build_bgectr},
      {PPC_INST_BGECTRL, build_bgectrl},
      {PPC_INST_BNLCTR, build_bgectr},
      {PPC_INST_BNLCTRL, build_bgectrl},
      {PPC_INST_BLECTR, build_blectr},
      {PPC_INST_BLECTRL, build_blectrl},
      {PPC_INST_BNGCTR, build_blectr},
      {PPC_INST_BNGCTRL, build_blectrl},
      {PPC_INST_BNECTR, build_bnectr},
      {PPC_INST_BNECTRL, build_bnectrl},
      {PPC_INST_BNSCTR, build_bnsctr},
      {PPC_INST_BNSCTRL, build_bnsctrl},
      {PPC_INST_BNUCTR, build_bnsctr},
      {PPC_INST_BNUCTRL, build_bnsctrl},
      {PPC_INST_BTCTR, build_btctr},
      {PPC_INST_BTCTRL, build_btctrl},
      {PPC_INST_BFCTR, build_bfctr},
      {PPC_INST_BFCTRL, build_bfctrl},
      {PPC_INST_BCCTR, build_bcctr},
      {PPC_INST_BCCTRL, build_bcctrl},
      {PPC_INST_BDZ, build_bdz},
      {PPC_INST_BDZF, build_bdzf},
      {PPC_INST_BDZLR, build_bdzlr},
      {PPC_INST_BDNZFLR, build_bdnzflr},
      {PPC_INST_BDNZFLRL, build_bdnzflrl},
      ...
      {PPC_INST_BEQR, build_beqlr},
      {PPC_INST_BEQLRL, build_beqlrl},
      {PPC_INST_BEQRL, build_beqlrl},
      {PPC_INST_BNE, build_bne},
      {PPC_INST_BNELR, build_bnelr},
      {PPC_INST_BNER, build_bnelr},
      {PPC_INST_BNELRL, build_bnelrl},
      {PPC_INST_BNERL, build_bnelrl},
      {PPC_INST_BLT, build_blt},
      {PPC_INST_BLTLR, build_bltlr},
      {PPC_INST_BLTR, build_bltlr},
      {PPC_INST_BLTLRL, build_bltlrl},
      {PPC_INST_BLTRL, build_bltlrl},
      {PPC_INST_BGE, build_bge},
      {PPC_INST_BGELR, build_bgelr},
      {PPC_INST_BGER, build_bgelr},
      {PPC_INST_BNLLR, build_bgelr},
      {PPC_INST_BNLR, build_bgelr},
      {PPC_INST_BGELRL, build_bgelrl},
      {PPC_INST_BGERL, build_bgelrl},
      {PPC_INST_BNLLRL, build_bgelrl},
      {PPC_INST_BNLRL, build_bgelrl},
      {PPC_INST_BGT, build_bgt},
      {PPC_INST_BGTLR, build_bgtlr},
      {PPC_INST_BGTR, build_bgtlr},
      {PPC_INST_BGTLRL, build_bgtlrl},
      {PPC_INST_BGTRL, build_bgtlrl},
      {PPC_INST_BLE, build_ble},
      {PPC_INST_BLELR, build_blelr},
      {PPC_INST_BLER, build_blelr},
      {PPC_INST_BNGLR, build_blelr},
      {PPC_INST_BNGR, build_blelr},
      {PPC_INST_BLELRL, build_blelrl},
      {PPC_INST_BLERL, build_blelrl},
      {PPC_INST_BNGLRL, build_blelrl},
      {PPC_INST_BNGRL, build_blelrl},
      {PPC_INST_BSO, build_bso},
      {PPC_INST_BSOLR, build_bsolr},
      {PPC_INST_BSOR, build_bsolr},
      {PPC_INST_BUNLR, build_bsolr},
      {PPC_INST_BSOLRL, build_bsolrl},
      {PPC_INST_BSORL, build_bsolrl},
      {PPC_INST_BUNLRL, build_bsolrl},
      {PPC_INST_BNS, build_bns},
      {PPC_INST_BNSLR, build_bnslr},
      {PPC_INST_BNSR, build_bnslr},
      {PPC_INST_BNULR, build_bnslr},
      {PPC_INST_BNSLRL, build_bnslrl},
      {PPC_INST_BNSRL, build_bnslrl},
      {PPC_INST_BNULRL, build_bnslrl},
      {PPC_INST_BTLR, build_btlr},
      {PPC_INST_BBTR, build_btlr},
      {PPC_INST_BTLRL, build_btlrl},
      {PPC_INST_BBTRL, build_btlrl},
      {PPC_INST_BFLR, build_bflr},
      {PPC_INST_BBFR, build_bflr},
      {PPC_INST_BFLRL, build_bflrl},
      {PPC_INST_BBFRL, build_bflrl},
