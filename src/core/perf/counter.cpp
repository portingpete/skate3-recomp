...
REXCVAR_DEFINE_INT32(perf_guest_functions_top_n, 0, "Perf",
                     "Write the top N generated guest functions to a sidecar perf CSV when "
                     "generated guest-function probes were compiled in");
REXCVAR_DEFINE_INT64(
    perf_guest_functions_min_exclusive_us, 0, "Perf",
    "Minimum active exclusive guest-function time, in microseconds, for sidecar perf CSV when "
    "generated guest-function probes were compiled in");
