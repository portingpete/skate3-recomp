...
Require-Contains $setupPs1 "Start-Skate3SetupChildProcess"
Require-Contains $setupPs1 "System.Windows.Forms.Timer"
Require-Contains $setupPs1 "Read-SharedTextFile"
Require-Contains $setupPs1 "-SetupOnly"
Require-NotContains $setupPs1 "System.ComponentModel.BackgroundWorker"
Require-NotContains $setupPs1 ".add_DoWork("
Require-NotContains $setupPs1 ".add_ProgressChanged("
Require-NotContains $setupPs1 ".add_RunWorkerCompleted("
Require-NotContains $setupPs1 ".add_OutputDataReceived("
Require-NotContains $setupPs1 ".add_ErrorDataReceived("
