...
std::string FunctionNode::emitCpp(const EmitContext& ctx) const {
  ...
  if (generateSeh) {
    ...
    emit_println(body,
                 ...
                 "last_mem=0x{{:08X}} last_mem_op={{}} last_mem_ea=0x{{:08X}} "
                 "fault_mem=0x{{:08X}} fault_mem_op={{}} fault_mem_ea=0x{{:08X}} r1=0x{{:08X}} "
                 ...
                 "ctx.last_guest_memory_effective_address, seh_state.guest_fault_instruction, "
                 "seh_state.guest_fault_operation != nullptr ? seh_state.guest_fault_operation : \"\", "
                 "seh_state.guest_fault_effective_address, ctx.r1.u32, ctx.r3.u32, ctx.r4.u32, "
